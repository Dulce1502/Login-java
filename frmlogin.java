...
public class frmlogin extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if ( !usuario.equals("") || !pass.equals("")) {
            try {
                java.sql.PreparedStatement ps = cn.prepareStatement("SELECT tipo_nivel FROM usuarios WHERE email = '"+usuario+"' AND clave = '"+pass+"'");
                ResultSet rs = ps.executeQuery(); 
                if (rs.next()) {
                    String tipoNivel = rs.getString("tipo_nivel");
                    if (tipoNivel.equalsIgnoreCase("Administrador")) {
                        dispose();
                        Admin ad = new Admin(null,true);
                        ad.setVisible(true);
                    }else if(tipoNivel.equalsIgnoreCase("Cliente")){
                        dispose();
